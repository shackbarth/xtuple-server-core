    ...
    */
    ...
    run: function (options) {
      var install_format = {
        ...
        pm2_init_sh_path = path.resolve(__dirname, 'pm2-init.sh'),
        pm2_init_sh = fs.readFileSync(pm2_init_sh_path);
      ...
      fs.writeFileSync(pm2_init_sh_path, pm2_init_sh);

      exec(['pm2 start', pm2_web_conf_target, '-x -u xtnode'].join(' '));
