(function () {
  ...
  _.extend(serverconfig, /** @exports serverconfig */ {
    ...
    run: function (options) {
      ...
      exec('sudo -u xtuple mkdir -p ' + config_path);
      exec('sudo -u xutple mkdir -p ' + ssl_path);
      exec('sudo -u xtuple mkdir -p ' + log_path);
      ...
      exec('sudo -u xtuple chmod -R 440 /etc/xtuple');
      exec('sudo -u xtuple chmod -R 440 /var/log/xtuple');
      exec('sudo -u xtuple chmod -R 440 /usr/local/xtuple');
