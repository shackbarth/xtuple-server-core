  ...
  _.extend(build, /** @exports build */ {
    ...
    run: function (options) {
      var xt = options.xt,
        ...
        build_template = 'node {bin} -i -b {backup} -d {dbname} -c {configjs} >> {logfile}',
        extension_template = 'node {bin} -d {dbname} -e {ext_path} -c {configjs} >> {logfile}',
