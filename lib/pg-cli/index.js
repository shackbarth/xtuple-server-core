(function () {
  ...
  _.extend(cli, /** @exports cli */ {
    ...
    psql: function (options, query) {
      return exec([
        'sudo -u {xt.name} /usr/lib/postgresql/9.3/bin/psql',
        '{dbname}',
    ...
    restore: function (params) {
      var pg_restore = 'sudo -u {xt.name} /usr/lib/postgresql/9.3/bin/pg_restore';
    ...
    createdb: function (params) {
      var cmd = [
          'sudo -u {xt.name} /usr/lib/postgresql/9.3/bin/createdb',
          '{dbname}',
          //'-h /var/run/postgresql/',
          '-U {xt.name}',
          '-p {pg.cluster.port}',
