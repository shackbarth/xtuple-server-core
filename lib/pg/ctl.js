(function () {
  ...
  _.extend(ctl, /** @exports ctl */ {
    ...
    createcluster: function (params) {
      ...
      return ctl.parse(result.stdout, 'pg_createcluster');
    },
    ...
    lsclusters: function () {
      ...
      return _.map(ctl.parse(result.stdout, 'pg_lsclusters'), function (cluster) {
    ...
    dropcluster: function (params) {
      var result = exec('pg_dropcluster {version} {name}'.format(params));
