...
(function () {
  ...
  _.extend(backupservice, task, /** @exports backupservice */ {
    ...
    run: function (options) {
      var version = options.xt.version,
        ...
        snapshot_path = backupservice.getBackupPath(version, name),
    ...
    coda: function (options) {
      exec('chown postgres:postgres /var/lib/postgresql');
    },
  ...
  program
    ...
    .option('-t0 --snapshott0 [integer]', backupservice.options.snapshott0.description)
    ...
    .action(function (options) {
      ...
      scheduler.scheduleJob(rule, _.partial(backupservice.createSnapshot, options));
    });
